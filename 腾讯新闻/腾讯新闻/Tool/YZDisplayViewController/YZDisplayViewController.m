...
{
    if (_isShowTitleGradient && _titleColorGradientStyle == YZTitleColorGradientStyleRGB) {
         _norColor = [UIColor colorWithWhite:0.600 alpha:1.000];
    }
...
- (UIColor *)selColor
{
    ...
    if (_selColor == nil) _selColor = [UIColor blackColor];
...
- (void)viewDidLayoutSubviews
{
    ...
    self.contentScrollView.frame = _isfullScreen?CGRectMake(0, 0, contentW, YZScreenH) :CGRectMake(0, 0, contentW, self.contentView.height - contentScrollY);
